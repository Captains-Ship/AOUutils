...
class Misc(commands.Cog):
    ...
    async def userinfo(self, ctx, member: discord.Member):
        ...
        embed.add_field(name="Creation Date:", value=member.created_at.strftime("%B/%d/%Y %I:%M:%S%p"))
        embed.add_field(name="Joining Date:", value=member.joined_at.strftime("%B/%d/%Y %I:%M:%S%p"))
